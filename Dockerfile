...
ARG GIT_SHA="dev"
LABEL org.opencontainers.image.source="https://github.com/rext-dev/SetAi-API" \
	org.opencontainers.image.revision="$GIT_SHA" \
	org.opencontainers.image.title="SetAi API" \
	org.opencontainers.image.description="API para el Bot de Discord autónomo impulsado por IA" \
